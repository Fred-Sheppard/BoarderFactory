...
public class uiTestingLegacy {
    public static void main(String[] args) {
        // Create components using the Legacy factory
        AbstractGuiFactory factory = new LegacyGuiFactory();
        ...
        for (int step = 0; step < 100; step++) {
            ...
            // Move passengers
            for (int i = 0; i < passengers.length; i++) {
                // Use the passenger's built-in movement method
